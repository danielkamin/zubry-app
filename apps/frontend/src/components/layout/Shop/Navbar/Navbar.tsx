          ...
          <div className="flex items-center justify-between h-16">
            <div className="w-full justify-between flex items-center">
              <div className="flex-shrink-0  flex items-center  ">
                <Link href="/" className="h-12 hover:opacity-70 transition">
                ...
                <Link href="/sklep" className="hover:text-purple-600 transition text-gray-900">
            ...
            <div className="-mr-2 flex md:hidden text-2xl items-center gap-2">
              <Link
                href="/sklep/koszyk"
                className="text-gray-900 flex hover:text-gray-400  px-3 py-2 rounded-md font-medium relative"
              >
                <ShoppingCartOutlined />
                {products.length > 0 && (
                  <span className="text-lg absolute right-0 bottom-0 text-purple-600">{products.length}</span>
              ...
              {status === 'authenticated' ? (
                <>
                  <Link
                    href="/sklep/konto"
                    className="text-gray-900 flex hover:text-gray-400  px-3 py-2 rounded-md font-medium"
                  >
                    <UserOutlined />
                  </Link>
                  <span
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
              <Link href="/sklep/produkty" className="text-gray-900 block px-3 py-2 rounded-md text-base font-medium">
                Produkty
              </Link>
            </div>
          </div>
