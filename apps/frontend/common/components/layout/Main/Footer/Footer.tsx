  ...
  return (
    <footer className="md:h-64 h-v75 w-100 grid md:grid-flow-col grid-flow-row md:gap-6 gap-10 justify-items-center bg-black justify-evenly text-white font-medium py-12 font-sans">
      ...
      <div className="grid grid-rows-3 items-center  justify-items-center">
        <Link href="/ciasteczka">
          <a className="transition-opacity hover:opacity-75">Polityka Prywatności</a>
        </Link>
        <Link href="/sklep">
          <a className="transition-opacity hover:opacity-75">Sklep</a>
        </Link>
        <Link href="/kontakt">
          <a className="transition-opacity hover:opacity-75">Kontakt</a>
        </Link>
      </div>
